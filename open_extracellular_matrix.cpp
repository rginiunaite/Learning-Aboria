...
//                }
                    ...
                    if (free_position && round((x[0] * (length_x / domain_length))) >= 0 &&
                        ...
                        get<position>(particles)[particle_id(j)] += 0.5 * speed_f * vdouble2(sin(random_angle), cos(random_angle)); // update if nothing is in the next position
                    }
                }
